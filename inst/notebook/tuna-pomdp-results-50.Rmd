...
list(plus_hindcast = compare_plus(models = m$models, discount = m$discount,
                              obs = y, action = a, alphas = m$alphas),
     mdp_hindcast = mdp_historical(m$transitions, m$reward, m$discount, state = y, action = a))
...
plus_forecast <- 
plus_replicate(40, 
               sim_plus(models = m$models, discount = m$discount,
